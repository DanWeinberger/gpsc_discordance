...
cog_freq.c <- reshape2::dcast(D, Gene+Annotation ~ change_serogrp) %>%
...
unique.genes2 <- unique.genes %>%
  ...
  #ridge regression
cv.lasso <- cv.glmnet(x, y, family = "binomial",type.measure="class", nfolds=10)
